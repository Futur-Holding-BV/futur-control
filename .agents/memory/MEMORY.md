...
- [GitHub organization access](github-organization-access.md) — shell Git credentials and the bound GitHub connector can have different organization permissions; verify both independently.
